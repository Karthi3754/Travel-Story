    ...
    return(
        <div className="h-screen bg-cyan-50 overflow-hidden relative">
            ...
            <div className="container h-screen flex items-center justify-center px-20 mx-auto">
                ...
                <div className="w-2/4 h-[75vh] bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/200">
                    ...
                    <button
                    type="button" /* Change type to "button" to prevent conflict with form submission */
